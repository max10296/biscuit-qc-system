...
(function() {
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="password" id="current-password" class="w-full p-2 border rounded" placeholder="Enter current password" autocomplete="current-password" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1">New Password:</label>
                            <input type="password" id="new-password" class="w-full p-2 border rounded" placeholder="Enter new password" autocomplete="new-password" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1">Confirm New Password:</label>
                            <input type="password" id="confirm-password" class="w-full p-2 border rounded" placeholder="Confirm new password" autocomplete="new-password" required>
                        </div>
    ...
    window.SettingsPasswordProtection = {
        ...
        resetPassword: function() {
            // Emergency reset function (should be protected in production)
